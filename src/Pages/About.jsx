        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <motion.img
              src={img}
              alt="Akash Ahamed"
              className="rounded-xl w-full max-w-md border-4 border-blue-500/20 shadow-2xl transform transition-all duration-500 filter grayscale hover:grayscale-0"
          ...
          >
            ...
            >
              {/* CTA buttons future add korte paro */}
            </motion.div>
          </motion.div>
        </div>
      </div>
